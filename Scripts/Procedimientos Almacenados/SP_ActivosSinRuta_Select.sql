...
GO
IF  EXISTS (SELECT * FROM SYS.OBJECTS WHERE TYPE = 'P' AND NAME = 'SP_ActivosSinRuta_Select')
DROP PROCEDURE SP_ActivosSinRuta_Select
GO
-- =============================================
-- Author:		<Author,,Name>
...
-- =============================================
CREATE PROCEDURE SP_ActivosSinRuta_Select
