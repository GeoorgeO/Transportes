...
BEGIN
	...
	if @Existe>0 
		...
		begin
			INSERT INTO Huerta
								 (Id_Huerta, Nombre_Huerta, Registro_Huerta, Id_Duenio, Id_Estado, Id_Ciudad, Id_Calidad, Id_Cultivo, zona_Huerta, banda_Huerta, este_Huerta, norte_Huerta, asnm_Huerta, latitud_Huerta, longitud_Huerta)
			VALUES        (@maximo,@Nombre_Huerta,@Registro_Huerta,@Id_Duenio,@Id_Estado,@Id_Ciudad,@Id_Calidad,@Id_Cultivo,@zona_Huerta,@banda_Huerta,@este_Huerta,@norte_Huerta,@asnm_Huerta,@latitud_Huerta,@longitud_Huerta)
		end
